...
class DataProcessing:
    ...
    def get_class_weights(dataset_name, num_per_class=0, name='sqrt'):
        ...
        elif dataset_name == 'SensatUrban' or dataset_name == 'Toronto3D':
...
class Plot:
    ...
    def draw_pc_sem_ins(pc_xyz, pc_sem_ins, plot_colors=None):
        ...
        if plot_colors is not None:
            ...
            #               ]
            ins_colors = [[0, 255, 0],  # ground -> OliveDrab
                          [0, 0, 255],  # tree -> Green
                          [0, 255, 255],  # building -> orange
                          [255, 255, 0],  # Walls ->  darkblue
                          [255, 0, 255],  # Bridge -> black
                          [100, 100, 255],  # parking -> blue
                          [200, 200, 100],  # rail -> Magenta
                          [170, 120, 200],
                          [255, 0, 0],  # traffic Roads ->  grey
                          [200, 100, 100],  # Street Furniture  ->  DimGray
                          [10, 200, 100],  # cars -> red
                          [200, 200, 200],  # Footpath  ->  deeppink
                          [50, 50, 50],  # bikes -> cyan
                           # water ->  skyblue
                          ]
        ##############################
