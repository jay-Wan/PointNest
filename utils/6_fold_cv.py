...
if __name__ == '__main__':
    base_dir = '../test/PointNest_dense_s3dis_without_FAB/val_preds1'
    original_data_dir = '../S3DIS/original_ply'
    ...
    for file_name in data_path:
        ...
        _, pre_colors = Plot.draw_pc_sem_ins(points, pred)
        name = file_name.split('/')[-1]
        # dir = '/media/dell/data/wanjie/RandLA-Net/S3DIS/'
        # write_ply(os.path.join(dir, 'val_preds1', name.split('.')[0]+'_pre.ply'), [points, pre_colors], ['x', 'y', 'z', 'red', 'green', 'blue'])
