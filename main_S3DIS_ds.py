...
class S3DIS:
    def __init__(self, test_area_idx):
        self.name = 'S3DIS'
        self.path = '/media/dell/data/wanjie/RandLA-Net/S3DIS'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='results/PointNest_dense_s3dis_with_only_GAP/snapshots/snap-33001', help='pretrained model path')
